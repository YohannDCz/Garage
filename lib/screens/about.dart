                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Column(
                                                ...
                                                mainAxisSize: MainAxisSize.min,
                                                children: [
                                                  Text('Lundi', style: Theme.of(context).textTheme.bodyMedium),
                                                  height16,
                                                  Text('Mardi', style: Theme.of(context).textTheme.bodyMedium),
                                                  height16,
                                                  Text('Mercredi', style: Theme.of(context).textTheme.bodyMedium),
                                                  height16,
                                                  Text('Jeudi', style: Theme.of(context).textTheme.bodyMedium),
                                                  height16,
                                                  Text('Vendredi', style: Theme.of(context).textTheme.bodyMedium),
                                                  height16,
                                                  Text('Samedi', style: Theme.of(context).textTheme.bodyMedium),
                                                  height16,
                                                  Text('Dimanche', style: Theme.of(context).textTheme.bodyMedium),
                                                ],
                                              ),
                                              width32,
                                              if (state is SchedulesFetchReady)
                                                Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    height6,
                                                    Schedule(readOnly: !isEditing, controller: wednesdayController, label: state.schedules.wednesday),
                                                    height6,
                                                    Schedule(readOnly: !isEditing, controller: thursdayController, label: state.schedules.thursday),
                                                    height6,
                                                    Schedule(readOnly: !isEditing, controller: fridayController, label: state.schedules.friday),
                                                    height6,
                                                    Schedule(readOnly: !isEditing, controller: saturdayController, label: state.schedules.saturday),
                                                    height6,
                                                    Schedule(readOnly: !isEditing, controller: sundayController, label: state.schedules.sunday),
                                                    height6,
                                                  ],
                                                )
                                            ],
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          height40,
                                          Text('Téléphone:', style: Theme.of(context).textTheme.bodyMedium),
                                        ],
                                      ),
                                      width8,
                                      Column(
                                        ...
                                        mainAxisSize: MainAxisSize.min,
                                        children: [
                                          Text('2-20 Avenue Président Salvador Allende,\nMozinor,\n93100 Montreuil', style: Theme.of(context).textTheme.bodyMedium),
                                          Text('01.48.57.33.49', style: Theme.of(context).textTheme.bodyMedium),
                                        ],
                                      ),
                                    ],
                                  ),
                                ...
                                child: Padding(
                                  ...
                                  child: Form(
                                    ...
                                    child: Column(
                                      ...
                                      mainAxisSize: MainAxisSize.min,
                                      children: [
                                        FormFieldHint(nameController: nameController, hint: 'Nom complet', validator: ValidatorService.validateName),
                                        height8,
                                        FormFieldHint(nameController: phoneController, hint: 'Numéro de téléphone', validator: ValidatorService.validatePhone),
                                        height8,
                                        FormFieldHint(nameController: emailController, hint: 'Adresse email', validator: ValidatorService.validateEmail2),
                                        height8,
                                        FormFieldHint(nameController: messageController, hint: 'Message', validator: ValidatorService.validateMessage, maxLines: 12),
                                        height8,
                                        ElevatedButton(onPressed: onPressed, style: buttonStyle, child: const Text('Envoyer')),
                                      ],
                                    ),
                                  ),
                                ),
